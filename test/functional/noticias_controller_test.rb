...
class NoticiasControllerTest < ActionController::TestCase
  ...
  test "should create noticia" do
    assert_difference('Noticia.count') do
      post :create, noticia: { ativo: @noticia.ativo, conteudo: @noticia.conteudo, data_publicacao: @noticia.data_publicacao, resumo: @noticia.resumo, titulo: @noticia.titulo }
    end
  ...
  test "should update noticia" do
    put :update, id: @noticia, noticia: { ativo: @noticia.ativo, conteudo: @noticia.conteudo, data_publicacao: @noticia.data_publicacao, resumo: @noticia.resumo, titulo: @noticia.titulo }
    assert_redirected_to noticia_path(assigns(:noticia))
  end
